...
export { default as CreateReminderPage } from "./reminders/features/create_reminders/pages";
export { default as EditReminderPage } from "./reminders/features/edit_reminders/pages";
