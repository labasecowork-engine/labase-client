...
import { UNITS } from "@/modules/admin/inventory/constants";
import { useBrandManager } from "@/modules/admin/inventory/hooks";
import { useQuery } from "@tanstack/react-query";
import { getBrands } from "@/modules/admin/inventory/services";
import { DialogManager } from "@/modules/admin/inventory/components";
import type { Brand } from "@/types/inventory";
import type { CreateProductFormData } from "../../../create_product/types";
...
export const EditProductInfoSection = ({
  register,
  control,
  errors,
  watch,
      ...
      <DialogManager
        ...
        watch={
          watch as unknown as UseFormWatch<
            CreateProductFormData | EditProductFormData
          >
        }
